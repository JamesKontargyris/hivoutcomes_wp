...
function hivoutcomes_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'hivoutcomes' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'hivoutcomes_custom_background_args', array(
...
function hivoutcomes_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'hivoutcomes' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'hivoutcomes' ),
